  ...
  <section class="game">
    ...
    <form class="game__content  game__content--wide">
      <div class="game__option">
        <img src="${state.game2.questions[0].img.url}" alt="Option 0" width="705" height="455">
...
const getGame2Screen = getNode(game2Screen);

const backButtonNode = getGame2Screen.querySelector(`.back`);
const gameContentNode = getGame2Screen.querySelector(`.game__content`);

gameContentNode.addEventListener(`change`, (e) => {
  return handlers.getAnswerHandler(e, `game2`, `multipleChoise`, game3);
});
